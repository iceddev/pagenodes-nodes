...
module.exports = function (PN) {
    PN.nodes.registerType('change', { color: "#E2D96E",
        category: 'function',
        defaults: {
            name: { value: "" },
        ...
        oneditprepare: function oneditprepare() {
            ...
            $('#node-input-rule-container').css('min-height', '300px').css('min-width', '450px').editableList({
                addItem: function addItem(container, i, opt) {
                    ...
                    var propertyName = $('<input/>', { style: "width:250px", class: "node-input-rule-property-name", type: "text" }).appendTo(row1).typedInput({ types: ['msg', 'flow'] });
                    ...
                    var propertyValue = $('<input/>', { style: "width:250px", class: "node-input-rule-property-value", type: "text" }).appendTo(row2).typedInput({ default: 'str', types: ['msg', 'flow', 'str', 'num', 'bool', 'json', 'date'] });
                    ...
                    var fromValue = $('<input/>', { style: "width:250px", class: "node-input-rule-property-search-value", type: "text" }).appendTo(row3_1).typedInput({ default: 'str', types: ['msg', 'flow', 'str', 're', 'num', 'bool'] });
                    ...
                    var toValue = $('<input/>', { style: "width:250px", class: "node-input-rule-property-replace-value", type: "text" }).appendTo(row3_2).typedInput({ default: 'str', types: ['msg', 'flow', 'str', 'num', 'bool', 'json'] });

                    $('<div/>', { style: "display:inline-block;text-align:right; width:120px; padding-right:10px; box-sizing:border-box;" }).text(to).appendTo(row4);
                    var moveValue = $('<input/>', { style: "width:250px", class: "node-input-rule-property-move-value", type: "text" }).appendTo(row4).typedInput({ default: 'msg', types: ['msg', 'flow'] });
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        ' ',
                        React.createElement('span', { 'data-i18n': 'change.label.rules' })
                    )
                ),
                React.createElement(
                    'div',
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        ' property can either be a string value, or reference another message property by name, for example: ',
                        React.createElement(
                            'code',
                            null,
                            'msg.topic'
                    ...
                    React.createElement(
                        ...
                        ' - search & replace parts of the property. If regular expressions are enabled, the ',
                        React.createElement(
                            'b',
                            null,
                            'replace with'
                        ),
                        ' property can include capture groups, for example ',
                        React.createElement(
                            'code',
                            null,
                            '$1'
