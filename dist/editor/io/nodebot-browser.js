    ...
    render: function render() {
      return React.createElement(
        ...
        React.createElement(SelectRow, { name: "boardType", label: "Nodebot", icon: "gears", config: true,
          options: [['Arduino/Firmata', 'firmata'], ['Particle/Tinker', 'tinker-io']] }),
        React.createElement(
          "div",
          ...
          React.createElement(SelectRow, { name: "connectionType", label: "connection type", icon: "wrench", config: true,
            options: [['MQTT', 'mqtt'], ['Meshblu (skynet)', 'meshblu'], ['Bluetooth Serial', 'ble-serial'], ['WebUSB Serial', 'webusb-serial'], ['Splidi Serial', 'splidi'], ['Serial Port (plugin)', 'local'], ['TCP (plugin)', 'tcp']] }),
          React.createElement(
            "div",
