    ...
    render: function () {
      return (
        <div>
          ...
          <TextRow name="server" icon="globe" />
          ...
          <div id="uuidListDialog" title="Searching devices..." className="hide">
            <div className="form-row">
              <span id="serverName" />
            </div>
            <div className="form-row">
      ...
      return(
        <div>
          <div>
            ...
            <TextRow name="uuid" config={true} icon="user"/>
            <TextRow name="token" config={true} icon="lock"/>
